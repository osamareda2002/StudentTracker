...
namespace StudentTracker.Repository.Data.Migrations
{
    ...
    [Migration("20241202191456_RelateDepartmentWithLectures")]
    partial class RelateDepartmentWithLectures
    {
            ...
            modelBuilder.Entity("StudentTracker.Core.Entities.Lecture", b =>
                {
                    ...
                    b.Property<bool>("ProfessorAttended")
                        .HasColumnType("bit");
            ...
            modelBuilder.Entity("StudentTracker.Core.Entities.Lecture", b =>
                {
                    ...
                    b.HasOne("StudentTracker.Core.Entities.Lecture", "OriginalLecture")
                        .WithMany()
